...
<body>
    ...
    <header class="container" id="topic-container">
        ...
        <div class="topic">
            <p>
                Preencha as informações abaixo para concluir o cadastro:
            <p>
            <form class="row g-4">
                <div class="col-md-10">
                    <label for="validationServer01" class="form-label">Nome Completo</label>
                    <input type="text" class="form-control" value="" required placeholder="Gabriel da Silva">

                </div>
                <div class="col-md-10">
                    <label for="validationServer02" class="form-label">Telefone</label>
                    <input type="text" class="form-control" value="" required required placeholder="11 98456-6511">
                </div>
                <div class="col-md-10">
                    <label for="validationServerUsername" class="form-label">E-mail</label>
                    <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend3">@</span>
                        <input type="text" class="form-control" aria-describedby="inputGroupPrepend3 " required required placeholder="name@example.com">
                ...
                <div class="col-md-10">
                    <label for="validationServerUsername" class="form-label">Mensagem</label>
                ...
                <div class="d-grid  col-3">
                    <button class="btn btn-dark btn-s" type="submit">Enviar</button>
                </div>
            </form>
