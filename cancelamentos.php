...
<body>
    ...
    <header class="container" id="topic-container">
            ...
            <div class="topic">
                ...
                <p>
                    Cancelamento de compras realizadas no cartão de crédito: O cliente deve entrar em contato com empresa administradora do cartão e pedir o cancelamento 
                    do pagamento, sendo assim cancelaremos a compra em nosso sistema por falta de liberação do crédito;
                </p>
                <p>                    
